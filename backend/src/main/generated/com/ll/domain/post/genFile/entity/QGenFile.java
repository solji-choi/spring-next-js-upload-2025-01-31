...
public class QGenFile extends EntityPathBase<GenFile> {
    ...
    private static final long serialVersionUID = 374859368L;
    ...
    public final StringPath dirParents = createString("dirParents");
    ...
    public final StringPath ownerModelName = createString("ownerModelName");

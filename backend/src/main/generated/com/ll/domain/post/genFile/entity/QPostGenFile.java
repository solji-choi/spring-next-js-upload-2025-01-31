...
public class QPostGenFile extends EntityPathBase<PostGenFile> {
    ...
    public final QGenFile _super = new QGenFile(this);

    //inherited
    public final DateTimePath<java.time.LocalDateTime> createDate = _super.createDate;

    //inherited
    public final StringPath dirParents = _super.dirParents;

    //inherited
    public final StringPath downloadUrl = _super.downloadUrl;

    //inherited
    public final StringPath fileDir = _super.fileDir;
    ...
    //inherited
    public final StringPath originFileName = _super.originFileName;
